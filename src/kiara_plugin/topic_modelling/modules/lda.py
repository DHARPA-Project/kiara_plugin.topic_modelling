...
class RunLdaCoherence(KiaraModule):
    ...
    def create_outputs_schema(self):
        return {
            ...
            "top_topics": {
                "type": "list",
                "doc": "The topics generated by LDA with coherence."
            }
        }
    ...
    def process(self, inputs, outputs):
        ...
        try:
            model = gensim.models.ldamodel.LdaModel(corpus, id2word=id2word, num_topics=num_topics, alpha='auto', eta="auto", random_state=random_state, passes=passes, chunksize=chunksize, iterations=iterations)
        except Exception as e:
            raise KiaraProcessingException(
                f"Failed to run LDA: {e}"
            )
